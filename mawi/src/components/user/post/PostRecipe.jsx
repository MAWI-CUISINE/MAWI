...
<div className='row maindiv border '>
    <div className='imageforwiwi col-4' >
...
<div className="col-6 inputs" >
                    ...
                    <h2 className="title">YA MARIEM AL9ALNA ESM</h2>
                        ...
                        <div className="input row">
                            ...
                            <input className="input--style-2 col-4" type="text" placeholder="Recipe Name :"
...
/>
                        ...
                        <div className="row ">
                            <div className="">
                                <div className="input">
                                    <input className="input--style-2 js-datepicker" type="text" placeholder="Preparation Time:"  
                        ...
                        <div className="input">
                                    <input className="input--style-2 js-datepicker" type="text" placeholder="Cook Time :" 
                                       onChange={(event) => setPcook_time(event.target.value)}/>
                                    
                                </div>
                        <div className="input">
                                    <input className="input--style-2 js-datepicker" type="text" placeholder="Recipe image url :" 
                                ...
                                <div className="input">
                                    <input className="input--style-2 js-datepicker" type="text" placeholder="servings:"  
                                    onChange={(event) => setPserves(event.target.value)}
                                  />
                                  
                                </div>
                                <div className="input">
                                    <input className="input--style-2 js-datepicker" type="text" placeholder="description:"  
                        ...
                        <div className="row ">
                            <div className="">
                                ...
                                <h4>Ingredients:</h4>
                                    <textarea className="Array" type="text" 
